...
var miniAnimate2 = function() {
    $('.arrowwrapmini').css({'transition-delay':'0s', 'transition':'1s','opacity':'0'});
    $('.line3').css({'transition-delay':'0s', 'transition':'1s', 'margin-top':'12px', 'margin-bottom':'8px'});
    $('.line2').css({'transition-delay':'0s', 'transition':'1s', 'margin-top':'-6px', 'margin-bottom':'0px'});
    $('.line1').css({'transition-delay':'0s', 'transition':'1s', 'margin-top':'-15px'});
}
...
var miniAnimate = function() {
    ...
    if(miniAnimateCounter===3){
        ...
        $('.arrowwrapmini').css({'transition-delay':'0s', 'opacity':'0'});
    }
...
arrowButton.onclick = function() {
    ...
    if(canClickArrow) {
        ...
        if(clickCount === 0) {
            ...
            $('.secondpartcosmetics').css({'transition-delay':'0s', 'transition':'1s', 'margin-top':'-275px', 'opacity':'0', 'z-index':'-200'});
            $('.dahasonragonder').css({'transition-delay':'0s', 'transition':'0s', 'opacity':'0', 'z-index':'-300'});
...
var showResult = function() {
    ...
    if(clickCount===2){
        ...
        $('.somedefinitions').css({'margin-top':'-35px', 'padding-top':'8px', 'padding-bottom':'8px', 'border-top':'2px solid','border-bottom':'2px solid'});
        setTimeout('introduceContests()', 6000);
    }
...
var introduceContests = function() {
    ...
    $('.somedefinitions, .continueButton').css({'opacity':'1'});
...
var showMoreText = function() {
    $('.colored').css({'margin-top':'-100px', 'margin-bottom':'20px'});
...
var show1 = function() {
    ...
    setTimeout('show15()', 1000);
}


var show15 = function() {
    $('.lbar11').css({'border':'3px solid white'});
    setTimeout('show175()', 2000);
}
...
var show3 = function() {
    $('.sinfotitle').css({'transition':'1s','margin-bottom':'-20px', 'opacity':'0'});
...
var showResults2 = function() {
    ...
    if(clickCountf===2){
        ...
        $('.showlast2, .continueButton').css({'opacity':'1'});
...
Nbutton2.onclick = function() {
    if(canClickSecondButton)
    {
        ...
        $('.somedefinitions').css({'margin-top':'-163px'});
...
var goDown6 = function() {
    ...
    setTimeout('goDown7()', 12000);

}

var goDown7 = function() {
    $('.finaltext').css({'margin-top':'324px', 'opacity':'1'});
