...
var stopPlaying = function() {
    ...
    $('.slider, .lslider').css({'z-index':'-10'});
    document.getElementById('vSlider1').disable = true;
    document.getElementById('ovSlider1').disable = true;
    document.getElementById("vSlider1").addEventListener("mouseup", mouseUp);
    document.getElementById("ovSlider1").addEventListener("mouseup", mouseUp);
    // setTimeout('stopPlaying2()', 250);
    // setTimeout('shitHappens()', 250);
}

var notExperimenting = true;
...
myNext.onclick = function() {
    ...
    if(clickCount === 8) {
        ...
        notExperimenting = false;
        if(firstTimeStopPlaying) {
            $('.slider').css({'z-index':'1'});
            // $('.slider, .lslider').css({'z-index':'1'});
            // $('#lSlider1, #olSlider1').css({'z-index':'1'});
            document.getElementById('vSlider1').disable = false;
            document.getElementById('ovSlider1').disable = false;
