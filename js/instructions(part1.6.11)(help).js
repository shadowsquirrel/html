...
var changeMap2 = function(mystageIndex) {
    ...
    if(mystageIndex===3) {
        ...
        .css({'opacity':'0.1'});
        stageshortTextDisplay.innerHTML = '<strong>Leaders\' Contest I</strong> <br> <u>Winner</u> <strong>continues as leader</strong> and <strong>receives 1000</strong> tokens. <br> <strong>Winner\'s followers</strong> receive <strong>200</strong> tokens <strong>each</strong>.';
