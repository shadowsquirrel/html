...
var update = function(beliefSwitch) {
    ...
    updateHelpBar(info.h1, info.h2, 'helpbarg1', true);
    updateSaboBar(info.s1, info.s2, 'sabobarg1', true);
    ...
    updateHelpBar(info.oh1, info.oh2, 'helpbarg2', false);
    updateSaboBar(info.os1, info.os2, 'sabobarg2', false);
