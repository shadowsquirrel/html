...
initialize();
 $('.dslider').css({'cursor':'pointer'});


 var checkButton = document.getElementById('mycheck');
 ...
 var checkButton2 = document.getElementById('mycheck2');
 checkButton2.onclick = function() {
     if(document.getElementById('mycheck2').checked) {
         $('.locked2').css({'opacity':'1'});
         $('.unlocked2').css({'opacity':'0'});
     }
     if(!document.getElementById('mycheck2').checked) {
         $('.locked2').css({'opacity':'0'});
         $('.unlocked2').css({'opacity':'1'});
     }
 }
...
b025.onclick = function() {
    ...
    $('.mc075').css({'position':'static', 'opacity':'1', 'background-color':'lavenderblush'});
    $('.sliderbard').css({'border':'0px'});
...
b1.onclick = function() {
   ...
   $('.slider, .lslider, .dslider').css({'z-index':'-10', 'cursor':'default'});
...
goNext1 = function() {
    // $('.cb').css({'z-index':'-10'});
    $('#b21').css({'z-index':'1'});
    $('.mc21').css({'position':'static', 'opacity':'1', 'background-color':'lavender'});
    showleft();
    stopAnimations();
...
b3.onclick = function() {
    ...
    setTimeout('setFollowers2(19,28,32,14, 12,3,6,9, 0)', 1000);
    setTimeout('setFollowers2(7,7,6,8, 2,3,4,1, 1)', 2000);
    // setTimeout('setFollowers2(12,2,8,4, 5,20,13,7, 0)', 5000);
    // setTimeout('setFollowers2(14,7,19,2, 28,13,18,13, 1)', 4000);
    // setTimeout('setFollowers2(7,7,6,8 31, 13,17,27, 0)', 3000);
    // setTimeout('setFollowers2(19,28,32,14, 12,3,6,9, 1)', 6000);
...
var goNext2 = function() {
    ...
    $('.dsinfo, .decision').css({'display':'inline'});
    stopRotations();
    setFollowers();
    resetRotateMyValues12();
...
b4.onclick = function() {
    ...
    $('.lslider, .slider, .dslider').css({'z-index':'1', 'cursor':'pointer'});
...
var setFollowers = function() {
    ...
    updateBar(-13, 'bar3', 0, false);
    $('#vSlider3').prop('value', -13);
    $('#vSlider3').change();

    updateBar(-8, 'bar4', 0, false);
    $('#vSlider4').prop('value', -8);
    $('#vSlider4').change();
    ...
    updateBar(-5, 'obar3', 0, false);
    $('#ovSlider3').prop('value', -5);
    $('#ovSlider3').change();

    updateBar(-2, 'obar4', 0, false);
    $('#ovSlider4').prop('value', -2);
    $('#ovSlider4').change();
...
var setFollowers2 = function(a, b, a2, b2, c, d, c2, d2, helpcase) {
    ...
    if(helpcase===1) {
        ...
        updateBar(h3, 'bar3', 0, false);
        $('#vSlider3').prop('value', h3);
        $('#vSlider3').change();

        updateBar(h4, 'bar4', 0, false);
        $('#vSlider4').prop('value', h4);
        $('#vSlider4').change();
        ...
        updateBar(oh3, 'obar3', 0, false);
        $('#ovSlider3').prop('value', oh3);
        $('#ovSlider3').change();

        updateBar(oh4, 'obar4', 0, false);
        $('#ovSlider4').prop('value', oh4);
        $('#ovSlider4').change();
    }
    ...
    if(helpcase===0) {
        ...
        updateBar(-s3, 'bar3', 0, false);
        $('#vSlider3').prop('value', -s3);
        $('#vSlider3').change();

        updateBar(-s4, 'bar4', 0, false);
        $('#vSlider4').prop('value', -s4);
        $('#vSlider4').change();
        ...
        updateBar(-os3, 'obar3', 0, false);
        $('#ovSlider3').prop('value', -os3);
        $('#ovSlider3').change();

        updateBar(-os4, 'obar4', 0, false);
        $('#ovSlider4').prop('value', -os4);
        $('#ovSlider4').change();
    }
...
var rHfSlider = function(value2) {
    if(startRotate) {
        ...
        oh1 = oh2 = oh3 = oh4 = h2 = h3 = h4 = isHelp2 ? clickCountMyDecision2 : 0;
        os1 = os2 = os3 = os4 = s2 = s3 = s4 = isHelp2 ? 0 : -clickCountMyDecision2;
        var shBarValue = clickCountMyDecision2;

        updateBar(shBarValue, 'bar2', 0, false);
        updateBar(Math.ceil(shBarValue*1.25), 'bar3', 0, false);
        updateBar(Math.ceil(shBarValue*0.75), 'bar4', 0, false);
        updateBar(shBarValue, 'obar1', 0, false);
        updateBar(shBarValue, 'obar2', 0, false);
        updateBar(shBarValue*1, 'obar3', 0, false);
        updateBar(Math.ceil(shBarValue*1.3), 'obar4', 0, false);
...
var rotateMyValues2 = function(value, nr) {
    if(startRotate) {
        ...
        if(myrotation2===nr){
            ...
            updateBar(0, 'bar3', 0, false);
            updateBar(0, 'bar4', 0, false);
            updateBar(0, 'obar1', 0, false);
            updateBar(0, 'obar2', 0, false);
            updateBar(0, 'obar3', 0, false);
            updateBar(0, 'obar4', 0, false);
            $('#vSlider2,#vSlider3,#vSlider4, #ovSlider1,#ovSlider2,#ovSlider3,#ovSlider4').prop('value', 0);
            $('#vSlider2,#vSlider3,#vSlider4, #ovSlider1,#ovSlider2,#ovSlider3,#ovSlider4').change();
            $('#vSlider1, #dSlider').prop('value', 0);
            $('#vSlider1, #dSlider').change();
            h1 = h2 = h3 = h4 = oh4 = oh3 = oh2 = oh1 = s1 = s2 = s3 = s4 = os4 = os3 = os2 = os1 = 0;
            updateAll();
        }
    }
}
...
var genericOthers = function(value) {
    ...
    if(startRotate && (anotherCount2 != value)) {
        ...
        oh1 = oh2 = oh3 = oh4 = h4 = h3 = h2 = isHelp1 ? anotherCount2 : 0;
        os1 = os2 = os3 = os4 = s4 = s3 = s2 = isHelp1 ? 0 : -anotherCount2;
        var shBarValue = anotherCount2;

        updateBar(shBarValue, 'bar2', 0, false);
        updateBar(shBarValue, 'bar3', 0, false);
        updateBar(shBarValue, 'bar4', 0, false);
        updateBar(shBarValue, 'obar1', 0, false);
        updateBar(shBarValue, 'obar2', 0, false);
        updateBar(shBarValue, 'obar3', 0, false);
        updateBar(shBarValue, 'obar4', 0, false);

        $('#vSlider2, #vSlider3, #vSlider4, #ovSlider1, #ovSlider2, #ovSlider3, #ovSlider4').prop('value', shBarValue);
        $('#vSlider2, #vSlider3, #vSlider4, #ovSlider1, #ovSlider2, #ovSlider3, #ovSlider4').change();


        ////

        os3 = Math.ceil(os3 * 0.95);
        oh3 = Math.ceil(oh3 * 1.25);

        var temp = isHelp1 ? oh3 : -os3;

        updateBar(temp, 'obar3', 0, false);
        $('#ovSlider3').prop('value', temp);
        $('#ovSlider3').change();

        ///
        ////

        os4 = Math.ceil(os4 * 1.2);
        oh4 = Math.ceil(oh4/1.5);

        temp = isHelp1 ? oh4 : -os4;

        updateBar(temp, 'obar4', 0, false);
        $('#ovSlider4').prop('value', temp);
        $('#ovSlider4').change();
        ...
        s4 = Math.ceil(s4 * 0.35);
        h4 = Math.ceil(h4/3);

        var temp2 = isHelp1 ? h4 : -s4;

        updateBar(temp2, 'bar4', 0, false);
        $('#vSlider4').prop('value', temp2);
        $('#vSlider4').change();

        ////
        ///

        s3 = Math.ceil(s3 * 0.75);
        h3 = Math.ceil(h3/3);

        temp2 = isHelp1 ? h3 : -s3;

        updateBar(temp2, 'bar3', 0, false);
        $('#vSlider3').prop('value', temp2);
        $('#vSlider3').change();
